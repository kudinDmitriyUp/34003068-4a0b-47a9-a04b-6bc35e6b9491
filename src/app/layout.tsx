...
export const metadata: Metadata = {
  title: "Webild - AI Chat for Your Website",
  description: "Transform your website with Webild's AI-powered chatbot. Engage visitors, automate support, and boost conversions with natural language conversations.",
  keywords: "AI chatbot, website chat, conversational AI, customer support automation, lead qualification",
  metadataBase: new URL('https://webild.ai'),
  alternates: {
    canonical: 'https://webild.ai'
  },
  robots: {
    index: true,
    follow: true
  ...
  openGraph: {
    title: "Webild - AI Chat for Your Website",
    description: "Transform your website with Webild's AI-powered chatbot. Engage visitors, automate support, and boost conversions.",
    type: "website",
    siteName: "Webild",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764874647097-mg3e389a.jpg",
      alt: "Webild AI Chat Interface"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "Webild - AI Chat for Your Website",
    description: "Engage visitors with intelligent AI conversations. Automate support and boost conversions.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764874647097-mg3e389a.jpg"]
  }
};
